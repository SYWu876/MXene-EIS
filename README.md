...
- `figures/` Pre-rendered manuscript and supporting information figures (DOCS/PDF)
- `tables/`  Pre-rendered manuscript and supporting information tables (DOCX/PDF/CSV)
- `notes/`  Pre-rendered supporting information notes (DOCX/PDF)
## Environment
```bash
...
- `figures/Regen_*` QAOA γ–β heatmaps (Figure S6-style)
- `data/Regen_FigureS5_*` best-shot tables + `figures/Regen_FigS5_*` top-10 counts
